	...
	<div class="text-center">
		<form class="form-signin" method="post" action="LoginAction.jsp">
			...
			<div class=form-group>
				...
				<input type="text" id="ID" name="id" class="form-control" placeholder="아이디" maxlength="20" required autofocus>
			</div>
			<div class="form-group">
				<label for="Password">비밀번호</label>
				<input type="password" id="Password" name="password" class="form-control" placeholder="비밀번호" maxlength="20" required>
			</div>
