...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] REQUIRED_PERMISSIONS = {Manifest.permission.READ_PHONE_STATE, Manifest.permission.SEND_SMS, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_BACKGROUND_LOCATION};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                smsManager.sendTextMessage("01049097284", null, "테스트입니다.", null,null);
                Log.d("Check", "문자전송 성공");
            }
        });
